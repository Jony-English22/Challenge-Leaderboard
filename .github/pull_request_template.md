...
- [ ] ✨ Feature nueva (nueva funcionalidad)
- [ ] 📚 Documentación (actualización de README, guías, etc.)
- [ ] ⚠️ Breaking change (cambio que modifica el comportamiento existente)

## Checklist de cumplimiento
- [ ] El proyecto compila correctamente (`mvn clean compile`).
- [ ] Mi código sigue las convenciones de estilo (Java 17).
- [ ] He revisado mi propio código y agregado comentarios.
- [ ] He actualizado la documentación si añadí nuevos comandos.